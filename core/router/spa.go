...
// https://godoc.org/github.com/cdren/iris/core/router#Router.WrapRouter
//
// Example: https://github.com/cdren/iris/tree/master/_examples/beginner/file-server/single-page-application-builder
