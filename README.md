...
<br/>
Iris is an <b>efficient</b> and well-designed, <b>cross-platform, web framework</b> with robust set of <b>features</b>. Build your own <b>high-performance</b> web applications and <b>APIs</b> powered by unlimited potentials and portability.
If you're coming from <a href="https://nodejs.org/en/">Node.js</a> world, this is the <a href="https://github.com/expressjs/express">expressjs</a> successor for the <a href="https://golang.org">Go Programming Language.</a>
<br/>
<br/>
