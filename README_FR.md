...
Pour une documentation encore plus complète vous pouvez visiter notre [godocs](https://pkg.go.dev/github.com/kataras/iris/v12@v12.2.7) (en Anglais). Et vous trouverez du code executable dans le dossier [\_examples](_examples/).
